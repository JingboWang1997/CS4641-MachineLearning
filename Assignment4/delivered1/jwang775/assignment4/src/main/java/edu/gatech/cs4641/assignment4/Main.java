package edu.gatech.cs4641.assignment4;
...
import edu.gatech.cs4641.assignment4.artifacts.Algorithm;
import edu.gatech.cs4641.assignment4.artifacts.Analysis;
import edu.gatech.cs4641.assignment4.artifacts.Hazard;
import edu.gatech.cs4641.assignment4.artifacts.Hazard.HazardType;
import edu.gatech.cs4641.assignment4.artifacts.PlannerFactory;
import edu.gatech.cs4641.assignment4.artifacts.Problem;
			...
			case PolicyIteration:
				runAlgorithm(analysis, problem, domain, hashingFactory, initialState, new PlannerFactory() {
					...
					public Planner createPlanner(int episodeIndex, SADomain domain, HashableStateFactory hashingFactory, SimulatedEnvironment simulatedEnvironment) {
						 ...
						 * iterations).
						 */
						return new PolicyIteration(domain, 0.99, hashingFactory, 0.4, 100, episodeIndex);
					}
				}, algorithm);
				break;
			default:
...
//						agent.setLearningPolicy(new RandomPolicy(domain));
	...
	private static Problem createProblem1() {
		...
		hazardRewardsHashMap.put(HazardType.LARGE, -5.0);
	...
	private static Problem createProblem2() {
		String[] map = new String[] {
				"000G0000000000000000000000L",
				"0L1011111111111111L0000000L",
				"0L1000000000000001L0000000L",
				"0L1111111111111101L0000000L",
				"0L1000000000000001L0000000L",
				"0L1011111111111111L0000000L",
				"0L1000000000000001M0000000M",
				"0L1111111111111101M0000000M",
				"0L1000000000000001M0000000M",
				"0L1011111111111111M0000000M",
				"0L1000000000000001M0000000M",
				"0L1111111111111101M0000000M",
				"0L1000000000000001M0000000M",
				"0L1011111111111111M0000000M",
				"0L1000000000000001S0000000S",
				"0L1111111111111101S0000000S",
				"0L1000000000000001S0000000S",
				"0L1011111111111111S0000000S",
				"0L1000000000000001S0000000S",
				"0L1111111111111101S0000000S",
				"0L1000000000000001S0000000S",
				"0L1011111111111111S0000000S",
				...
				"0L1111111111111101S0000000S",
				"0L1000000000000001S0000000S",
				"0L101111111111111110000000S",
				"0000000000000000000000X0000",
		};
